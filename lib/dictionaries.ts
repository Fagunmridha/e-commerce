...
const en = {
  ...
  wholesale: {
    ...
    market: {
      ...
      /** The filter panel beside the grid. */
      ...
      price: 'Price',
      offers: 'Offers',
      onlyOffers: 'Only discounted products',
      stock: 'Stock',
      onlyInStock: 'Only in-stock products',
      resetFilters: 'Reset filters',
      /** `{n}` is a count of listings. */
      results: 'Results: {n} products',
...
const bn: Dictionary = {
  ...
  wholesale: {
    ...
    market: {
      ...
      findProducts: 'পণ্য খুঁজুন',
      searchInCategory: 'এই ক্যাটাগরিতে খুঁজুন…',
      categories: 'ক্যাটাগরি',
      size: 'সাইজ',
      colour: 'রঙ',
      price: 'মূল্য',
      offers: 'অফার',
      onlyOffers: 'শুধু অফারের পণ্য দেখুন',
      stock: 'স্টক',
      onlyInStock: 'শুধু ইন-স্টক পণ্য দেখান',
      resetFilters: 'ফিল্টার রিসেট',
      results: 'ফলাফল: {n}টি পণ্য',
      found: '{n}টি পণ্য পাওয়া গেছে',
      all: 'সব',
      more: 'আরও',
      less: 'কম',
