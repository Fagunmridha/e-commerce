...
const en = {
  ...
  wholesale: {
    ...
    benefits: [
      {
        ...
        body: 'You set what each item sells for and the smallest order you will take. We never mark it up or discount it.',
      },
      {
    ...
    market: {
      ...
      sellCta: 'My shop',
      search: 'Search products or shops…',
    ...
    orders: {
      ...
      emptyBody:
        'When a buyer takes something from your shop, the order shows up here with their delivery details.',
      colOrder: 'Order',
      colBuyer: 'Buyer',
      colItems: 'Your items',
      colValue: 'Your total',
...
const bn: Dictionary = {
  ...
  wholesale: {
    ...
    benefits: [
      {
        ...
        body: 'কোন পণ্য কত দামে যাবে আর সর্বনিম্ন কত পিস নিতে হবে আপনিই ঠিক করবেন। আমরা বাড়াই-কমাই না।',
      },
      {
    ...
    market: {
      ...
      sellCta: 'আমার দোকান',
      search: 'পণ্য বা দোকান খুঁজুন…',
      allCategories: 'সব ক্যাটাগরি',
      soldBy: 'বিক্রেতা {shop}',
    ...
    orders: {
      ...
      searchPlaceholder: 'অর্ডার নম্বর বা ক্রেতা…',
      allStatuses: 'সব স্ট্যাটাস',
      noResults: 'এই খোঁজে কোনো অর্ডার মেলেনি।',
      clearFilters: 'ফিল্টার মুছুন',
      emptyTitle: 'এখনো কোনো অর্ডার নেই',
      emptyBody:
        'কেউ আপনার দোকান থেকে কিছু কিনলে অর্ডারটি ক্রেতার ঠিকানাসহ এখানে দেখাবে।',
      colOrder: 'অর্ডার',
      colBuyer: 'ক্রেতা',
      colItems: 'আপনার পণ্য',
      colValue: 'আপনার টাকা',
